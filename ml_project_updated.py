...
# Read the data
df = pd.read_csv('study_survey.csv')
...
g = sns.catplot(x="age_range", y="treatment", hue="Gender", data=df,
                kind="bar", errorbar=None, height=7, aspect=2, legend_out=True)
...
# Create the plot
g = sns.catplot(x="family_history", y="treatment", hue="Gender", data=df,
                kind="bar", errorbar=None, height=5, aspect=2, legend_out=True)
...
# Create the plot
g = sns.catplot(x="care_options", y="treatment", hue="Gender", data=df,
                kind="bar", errorbar=None, height=5, aspect=2, legend_out=True)
...
# Create the plot
g = sns.catplot(x="benefits", y="treatment", hue="Gender", data=df,
                kind="bar", errorbar=None, height=5, aspect=2, legend_out=True)
...
# Create the plot
g = sns.catplot(x="work_interfere", y="treatment", hue="Gender", data=df,
                kind="bar", errorbar=None, height=5, aspect=2, legend_out=True)
